"""
Live Timing Client - :mod:`fastf1_livetiming`
=============================================
...
There are two ways to interact with this module.
    ...
    - From the command line by calling ``python -m fastf1_livetiming``
...
.. code-block:: console
    ...
    python -m fastf1_livetiming save saved_data.txt
...
.. code-block::
    ...
    import fastf1
    from fastf1_livetiming.data import LiveTimingData
...
- You need to force a cache update if you modify the
  :class:`~fastf1_livetiming.data.LiveTimingData` (e.g. by adding a second
...
Available commands and options when calling ``python -m fastf1_livetiming``
...
.. code-block:: console
    ...
    usage: python -m fastf1_livetiming save [-h] [--append] [--debug]
...
.. code-block:: console
    ...
    usage: python -m fastf1_livetiming extract [-h] input output
...
.. automodule:: fastf1_livetiming.client
    :members:
    :undoc-members:
    :show-inheritance:
...
.. automodule:: fastf1_livetiming.data
    :members:
    :undoc-members:
    :show-inheritance:
